export default {
    getRssXMLFeed(geo) {
      ...
      return fetch(proxyurl+url).then(response=>response.text().then(text=>{
        console.log(text); 
        ...
        else // Internet Explorer https://stackoverflow.com/questions/53412949/activexobject-is-not-defined-no-undef-react-js
        {
        ...
        for (var itemIndex = 0; itemIndex < items.length; itemIndex++) {
          ...
          var linkIndex = 1; 
          var guidIndex = 2; 
          var titleNodeVal = items[itemIndex].childNodes[titleIndex].childNodes[0].nodeValue; 
          var linkNodeVal = items[itemIndex].childNodes[linkIndex].childNodes[0].nodeValue; 
          var guidNodeVal = items[itemIndex].childNodes[guidIndex].childNodes[0].nodeValue; 
