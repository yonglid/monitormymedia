...
//                 .map((row, index) => {
//                   const column1 = row.outlet;
//                   const column2 = row.title;
//                   const column3 = row.author;
//                   const isItemSelected = isSelected(column1);
//                   const labelId = `enhanced-table-checkbox-${index}`;

//                   return (
//                     <TableRow
//                       hover
//                       onClick={(event) => handleClick(event, column1)}
//                       role="checkbox"
...
function createData(name, title, author) {
...
const headCells = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Outlet' },
